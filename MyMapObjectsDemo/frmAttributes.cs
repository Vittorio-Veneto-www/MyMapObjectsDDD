...
namespace MyMapObjectsDemo
{
    public partial class frmAttributes : Form
    {
        ...
        private frmMain mainFrm; //主窗口，用来调用主窗口的各种属性和方法
        ...
        #region 构造函数
        public frmAttributes(MyMapObjects.moMapLayer layer, Int32 layerIndex, frmMain frm)
        {
            //（1）初始化主窗口
            InitializeComponent();
            this.mainFrm = frm;
        ...
        private void 按属性选择ToolStripMenuItem2_Click(object sender, EventArgs e)
        {
            ...
            if (isExist == false)
            {
                frmSelectedByAttributes frmQuery = new frmSelectedByAttributes(this);
        ...
        {
            frmNewField frm = new frmNewField(MapLayer);
            frm.ShowDialog();
        ...
        private void 删除字段ToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                frmDeleteField sFrmDeleteField = new frmDeleteField(mapLayer, this);
