...
namespace MyMapObjectsDemo
{
    ...
    {        
        ...
        private void subMenuSelectByAttri_Click(object sender, EventArgs e)
        {
            ...
            if (isExist == false)
            {
                frmAnyLayerSelectedByAttributes anySelectForm = new frmAnyLayerSelectedByAttributes(this, moMap.Layers);
        ...
        {
            frmCreateLayer createLayerForm = new frmCreateLayer(moMap.Layers);
        ...
        private void treeOpenAttributeForm_Click(object sender, EventArgs e)
        {
            ...
            if (isExist == false)
            {
                frmAttributes attributesForm = InitializeAttributesWindow(moMap.Layers.GetItem(layerIndex), layerIndex);
        ...
        {
            Int32 layerIndex = Convert.ToInt32(treeView1.SelectedNode.Name);
            frmLayerProperties propertiesForm = new frmLayerProperties(this, moMap.Layers.GetItem(layerIndex));
        ...
        {
            frmAddXY addXYForm = new frmAddXY();
        ...
        {
            frmAddDeltaXY addDeltaXYForm = new frmAddDeltaXY();
        ...
        // 属性表：初始化属性表图层
        private frmAttributes InitializeAttributesWindow(MyMapObjects.moMapLayer mapLayer, Int32 index)
        {
            frmAttributes attributesWindow = new frmAttributes(mapLayer, index, this);
