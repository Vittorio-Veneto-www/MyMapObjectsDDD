...
namespace MyMapObjectsDDD
{
    ...
    {        
        ...
        {
            Bitmap bmp = global::MyMapObjectsDDD.Properties.Resources.ZoomIn;
            Cursor cursor = new Cursor(bmp.GetHicon());
            myCursorZoomIn = cursor;
            bmp = global::MyMapObjectsDDD.Properties.Resources.ZoomOut;
            cursor = new Cursor(bmp.GetHicon());
            myCursorZoomOut = cursor;
            bmp = global::MyMapObjectsDDD.Properties.Resources.PanUp;
            cursor = new Cursor(bmp.GetHicon());
            myCursorPanUp = cursor;
            bmp = global::MyMapObjectsDDD.Properties.Resources.PanDown;
            cursor = new Cursor(bmp.GetHicon());
            myCursorPanDown = cursor;
            bmp = global::MyMapObjectsDDD.Properties.Resources.EditSelect;
            cursor = new Cursor(bmp.GetHicon());
            myCursorEditSelect = cursor;
            bmp = global::MyMapObjectsDDD.Properties.Resources.EditMove;
            cursor = new Cursor(bmp.GetHicon());
            myCursorEditMove = cursor;
            bmp = global::MyMapObjectsDDD.Properties.Resources.EditMoveVertex;
            cursor = new Cursor(bmp.GetHicon());
            myCursorEditMoveVertex = cursor;
            bmp = global::MyMapObjectsDDD.Properties.Resources.Cross;
            cursor = new Cursor(bmp.GetHicon());
